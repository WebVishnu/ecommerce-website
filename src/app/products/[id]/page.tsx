...
const ProductData = {
  ...
  name: "V-BOND MILK ANALYZER",
  originalPrice: 46000,
  stock: 20,
  vendor: "Vitco",
  availability: "In Stock",
  type: "Milk Testing machie",
};
...
export default function ProductPage() {
  ...
  const priceToDisplay = product.originalPrice;
      ...
      <div className="container mx-auto max-w-7xl py-10 px-4 lg:px-0 font-[family-name:var(--font-montserrat-regular)]">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-start">
          ...
          <div className="flex flex-col justify-center items-center">
            <a
              href={product.images[currentImage]}
              target="_blank"
              rel="noopener noreferrer"
              className="rounded-lg mb-4 h-[300px] md:h-[400px] lg:h-[500px] w-full "
            >
              <Image
          ...
          <div className="bg-white rounded-lg">
            <h1 className="text-2xl lg:text-3xl font-semibold mb-4 text-gray-900">
              {product.name}
            </h1>
            ...
            <div className="mb-6">
              <span className="text-3xl lg:text-3xl font-bold text-gray-900">
            ...
            <div className="flex gap-x-3 items-center">
              {addedToCart ? (
                ...
                <button
                  className="w-full bg-primary text-white font-semibold py-3 rounded-md hover:bg-sky-900 transition duration-500"
          ...
          <div className="fixed inset-0 flex justify-center items-center bg-black bg-opacity-50 z-50">
            <div className="bg-white relative p-8 rounded-md shadow-lg max-w-md w-full">
              ...
              <p className="text-gray-600">
                ...
                some restrictions apply, and some products cannot be shipped to
                international destinations.
              </p>
              <button
                className="text-white p-2 absolute top-0 right-0 bg-[#005ba3] transition-colors"
