...
>
      ...
      <div  className="flex flex-row w-full mt-4 items-center justify-between">
        ...
        <Link
          ...
          className="w-[70%] bg-white text-xs  items-center text-center sm:text-sm md:text-base lg:text-lg text-primary font-medium hover:text-white py-2 rounded-full hover:bg-primary transition-colors duration-700 border-[1px] border-primary"
        >
          Buy now
        </Link>
